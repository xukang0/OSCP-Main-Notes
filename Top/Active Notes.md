...
49152/udp open          domain        (generic dns response: SERVFAIL)
...
Enum4linux-ng gives me list of users on the system

When running impacket-GetNPUsers against the list of users to check for AS-rep Roasting, alfresco service accoount has a return hash.

Decrypt hash with john

Password obtained for alfresco

Netexec says winWR for alfresco is p3wned.

EvilwinRM brings me into alfresco and flag is found 
