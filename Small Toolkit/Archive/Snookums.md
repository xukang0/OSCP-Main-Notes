...
RFI from URL, https://www.exploit-db.com/exploits/48424

Get reverse shell and try to enter michael user

found db.php from /var/www/html

found db creds

enter mysql from reverse shell

find michael base64 hash, double decode

get ssh michael access

---

ls -la /etc/passwd reveals RW access.

Change michael group to root group

relogin into michael 

get ssh access as root with michael creds.
