...
C.Bum can write into inetpub development folder.

Runas to enter C.Bum shell

Chisel pivot to access port 8000 webpage

Put nc64.exe and shell.aspx into C:\inetpub\development and execute nc64.exe for a reverse shell to iis apppool\defaultapppool

whoami /priv shows SeImpersonatePrivelege

Since windows 10 machine, use Godpotato.exe

Get NT Authority shell in listener
